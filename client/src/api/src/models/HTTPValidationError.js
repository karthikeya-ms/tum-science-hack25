 ...
 * @module models/HTTPValidationError
 * @version 0.1.0
 */
class HTTPValidationError {
    /**
     * Constructs a new <code>HTTPValidationError</code>.
     * @alias module:models/HTTPValidationError
     */
    constructor() { 
     ...
     * @param {module:models/HTTPValidationError} obj Optional instance to populate.
     * @return {module:models/HTTPValidationError} The populated <code>HTTPValidationError</code> instance.
     */
...
/**
 * @member {Array.<module:models/ValidationError>} detail
 */
