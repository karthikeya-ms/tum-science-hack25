 ...
 * @module models/HelloWorldResponse
 * @version 0.1.0
 */
class HelloWorldResponse {
    /**
     * Constructs a new <code>HelloWorldResponse</code>.
     * @alias module:models/HelloWorldResponse
     ...
     * @param {module:models/HelloWorldResponse} obj Optional instance to populate.
     * @return {module:models/HelloWorldResponse} The populated <code>HelloWorldResponse</code> instance.
     */
