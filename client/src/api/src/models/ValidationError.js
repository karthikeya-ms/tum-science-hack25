 ...
 * @module models/ValidationError
 * @version 0.1.0
 */
class ValidationError {
    /**
     * Constructs a new <code>ValidationError</code>.
     * @alias module:models/ValidationError
     * @param loc {Array.<module:models/ValidationErrorLocInner>} 
     * @param msg {String} 
     * @param type {String} 
     */
     ...
     * @param {module:models/ValidationError} obj Optional instance to populate.
     * @return {module:models/ValidationError} The populated <code>ValidationError</code> instance.
     */
...
/**
 * @member {Array.<module:models/ValidationErrorLocInner>} loc
 */
